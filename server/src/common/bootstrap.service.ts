...
export class BootstrapService implements OnApplicationBootstrap {
  ...
  async onApplicationBootstrap(): Promise<void> {
    ...
    // 基础菜单需支持增量补齐，避免已有数据库因跳过种子而缺少新增菜单。
    await this.seedService.syncContractMenus();
    await this.seedService.syncSystemMenus();
    await this.seedService.syncContractDictionaries();
